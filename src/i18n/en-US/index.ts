...
export default {
  ...
  field: {
    ...
    day_now: 'Today',
    day_prev: 'Yesterday',
    day_backward_2: 'Last 2 days',
    week_now: 'This week',
    week_prev: 'Last week',
    week_backward_7: 'Last 7 days',
    month_now: 'This month',
    month_prev: 'Last month',
    month_backward_30: 'Last 30 days',
    quarter_now: 'This quarter',
    quarter_prev: 'Last quarter',
    year_now: 'This year',
    year_prev: 'Last year',
    reload: 'Reload',
